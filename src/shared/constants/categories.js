...
export const HIGH_SEVERITY_CATEGORIES = CATEGORY_KEYS.filter((key) => TRIGGER_CATEGORIES[key].severity === 'high');
export const MEDIUM_SEVERITY_CATEGORIES = CATEGORY_KEYS.filter((key) => TRIGGER_CATEGORIES[key].severity === 'medium');
export const LOW_SEVERITY_CATEGORIES = CATEGORY_KEYS.filter((key) => TRIGGER_CATEGORIES[key].severity === 'low');
