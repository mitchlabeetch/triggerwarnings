...
describe('UserSensitivityProfileManager', () => {
    ...
    it('should load profile from storage', async () => {
        ...
        StorageAdapter.get.mockResolvedValue(mockProfile);
    ...
    it('should save profile to storage', async () => {
        ...
        expect(StorageAdapter.set).toHaveBeenCalledWith('sensitivity_profile_test-user', expect.objectContaining({ userId: 'test-user' }));
    });
});
//# sourceMappingURL=UserSensitivityProfile.test.js.map